...
@javax.annotation.Generated(value = "io.swagger.codegen.languages.SpringCodegen", date = "2018-07-26T18:41:09.898Z")
...
public interface TemplateApi {
    ...
    @RequestMapping(value = "/template",
        ...
        method = RequestMethod.POST)
    ResponseEntity<String> addTemplate(@ApiParam(value = "Template object that needs to be added to the system" ,required=true )  @Valid @RequestBody MDTemplate templateData);
    ...
    ResponseEntity<String> deleteElement(@ApiParam(value = "The Template Guid. ",required=true) @PathVariable("templateGuid") String templateGuid,@ApiParam(value = "The Element guid needs to be fetched",required=true) @PathVariable("elementGuid") String elementGuid);
    ...
    @RequestMapping(value = "/template",
        ...
        consumes = { "application/json", "application/xml" },
        method = RequestMethod.PUT)
    ResponseEntity<String> updateTemplate(@ApiParam(value = "Template object that needs to be added to the system" ,required=true )  @Valid @RequestBody MDTemplate templateData);
